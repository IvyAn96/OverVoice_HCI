...
def shape_to_np(shape, dtype="int"):
    """
    Take a shape object (that is generated by dlib predictor) and conver that
...
def detect_action_units(shape, rect):
    """
    ...
    # Indentifying Action Unit 12: Lip Corner Puler
    left_lip_corner_x, left_lip_corner_y = shape[48]
    right_lip_corner_x, right_lip_corner_y = shape[54]
    ...
    while True:
        ...
        if cap.isOpened():
            ...
            for rect in rects:
                ...
                au_array = detect_action_units(shape, rect)
